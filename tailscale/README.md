Обновляю документацию в соответствии с актуальными скриптами.
...
Если DNS подменяется фильтрами (например, `198.18.0.x`), добавьте указанные выше домены в белый список.
